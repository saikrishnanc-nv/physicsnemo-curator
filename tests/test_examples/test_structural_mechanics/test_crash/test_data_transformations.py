...
def test_compute_node_type_all_wall():
    ...
    node_type = CrashDataTransformation.compute_node_type(pos_raw, threshold=1.0)
...
def test_compute_node_type_threshold():
    ...
    node_type = CrashDataTransformation.compute_node_type(pos_raw, threshold=0.3)
...
def test_build_edges_single_quad():
    ...
    edges = CrashDataTransformation.build_edges_from_mesh_connectivity(
        mesh_connectivity
    )
